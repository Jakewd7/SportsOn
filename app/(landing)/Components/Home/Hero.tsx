        ...
        <section id="hero-section" className="container mx-auto h-screen flex">
            <div className="relative self-center">
                ...
                <div className=" relative ml-0 md:ml-20 lg:ml-40 w-full">
                    ...
                    <h1 className="font-extrabold text-4xl md:text-6xl lg:text-[92px] italic bg-gradient-to-b leading-tight from-black to-[#979797] bg-clip-text text-transparent ">WEAR YOUR <br /> TOP-QUALITY <br /> SPORTSWEAR</h1>
